...
export default function ActivitiesDashboard({activities,selectedActivity,selectActivity,cancelActivity,editMode,openForm,closeForm,createOrEditActivity,deleteActivity}:Props){
  return (
    <div>
        <Grid>
            <GridColumn width='10'>
